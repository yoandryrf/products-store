function Header({ user }) {
  return (
    // <header>
    //   <div classNameName="header-left">
    //     <svg
    //       classNameName="w-6 h-6 text-white cursor-pointer fill-current"
    ...
    //       <div classNameName="user-avatar">
    //         <img src={user.avatar} alt="User Avatar" />
    //       </div>
    //       <div classNameName="user-name">{user.name}</div>
    //     </div>
    //   </div>
    // </header>

    <nav className="border-gray-200 bg-blue-300 dark:bg-blue-800 dark:border-blue-700">
